...
public class DeleteHandlerTest extends AbstractTestBase {
    ...
    protected static final Constant TEST_DELETE_BACKOFF_STRATEGY = Constant.of().timeout(Duration.ofSeconds(10L)).delay(Duration.ofSeconds(1L)).build();

    private final DeleteHandler handler = new DeleteHandler();
    private final DeleteHandler customHandlerToTestStabilization = new DeleteHandler(TEST_DELETE_BACKOFF_STRATEGY);
    ...
    public void tear_down() {
        verify(sdkClient, atLeastOnce()).deleteLandingZone(any(DeleteLandingZoneRequest.class));
    }

    @Test
    public void handleRequest_SimpleSuccess() {
        DeleteLandingZoneResponse deleteLandingZoneResponse = buildDeleteLandingZoneResponse();
        when(proxyClient.client().deleteLandingZone(any(DeleteLandingZoneRequest.class))).thenReturn(deleteLandingZoneResponse);
    ...
    public void handleRequest_deleteLandingZoneThrowsException(Class<Exception> expectedException) {
        when(proxyClient.client().deleteLandingZone(any(DeleteLandingZoneRequest.class))).thenThrow(expectedException);
    ...
    private DeleteLandingZoneResponse buildDeleteLandingZoneResponse() {
        return DeleteLandingZoneResponse.builder()
    ...
    private GetLandingZoneOperationResponse buildGetLandingZoneOperationResponse(LandingZoneOperationStatus landingZoneOperationStatus) {
        LandingZoneOperationDetail inProgressLandingZoneOperationDetail = LandingZoneOperationDetail.builder()
                .operationType(LandingZoneOperationType.DELETE)
